...
"")
        ...
        self.label_telefone_pedido = QLabel(self.frame_5)
        self.label_telefone_pedido.setObjectName(u"label_telefone_pedido")
        self.label_telefone_pedido.setFont(font2)

        self.horizontal_layout_12.addWidget(self.label_telefone_pedido)

        self.line_edit_telefone = QLineEdit(self.frame_5)
        self.line_edit_telefone.setObjectName(u"line_edit_telefone")

        self.horizontal_layout_12.addWidget(self.line_edit_telefone)


        self.verticalLayout_12.addLayout(self.horizontal_layout_12)
        ...
        self.horizontal_layout_4.addWidget(self.comboBox)
        ...
        self.label_item_pedido = QLabel(self.frame_12)
        self.label_item_pedido.setObjectName(u"label_item_pedido")
        self.label_item_pedido.setFont(font)

        self.verticalLayout_17.addWidget(self.label_item_pedido)

        self.horizontalLayout_7 = QHBoxLayout()
        self.horizontalLayout_7.setObjectName(u"horizontalLayout_7")
        self.combo_box_item_pedido = QComboBox(self.frame_12)
        self.combo_box_item_pedido.addItem("")
        self.combo_box_item_pedido.addItem("")
        self.combo_box_item_pedido.addItem("")
        self.combo_box_item_pedido.setObjectName(u"combo_box_item_pedido")

        self.horizontalLayout_7.addWidget(self.combo_box_item_pedido)

        self.spin_box_item_pedido = QSpinBox(self.frame_12)
        ...
        self.horizontalLayout_7.addWidget(self.spin_box_item_pedido)


        self.verticalLayout_17.addLayout(self.horizontalLayout_7)

        self.label_adicionais_pedido = QLabel(self.frame_12)
        self.label_adicionais_pedido.setObjectName(u"label_adicionais_pedido")
        self.label_adicionais_pedido.setFont(font)

        self.verticalLayout_17.addWidget(self.label_adicionais_pedido)

        self.horizontalLayout_15 = QHBoxLayout()
        self.horizontalLayout_15.setObjectName(u"horizontalLayout_15")
        self.combo_box_adicional_pedido = QComboBox(self.frame_12)
        ...
        self.horizontalLayout_15.addWidget(self.combo_box_adicional_pedido)

        self.spin_box_quantidade_acicionais = QSpinBox(self.frame_12)
        self.spin_box_quantidade_acicionais.setObjectName(u"spin_box_quantidade_acicionais")

        self.horizontalLayout_15.addWidget(self.spin_box_quantidade_acicionais)

        self.push_button_plus_adicional_pedido = QPushButton(self.frame_12)
        ...
        self.horizontalLayout_15.addWidget(self.push_button_plus_adicional_pedido)


        self.verticalLayout_17.addLayout(self.horizontalLayout_15)

        self.list_widget_adicionais_pedido = QListWidget(self.frame_12)
        self.list_widget_adicionais_pedido.setObjectName(u"list_widget_adicionais_pedido")
        self.list_widget_adicionais_pedido.setMinimumSize(QSize(0, 30))
        self.list_widget_adicionais_pedido.setMaximumSize(QSize(16777215, 50))

        self.verticalLayout_17.addWidget(self.list_widget_adicionais_pedido)

        self.label_ingredientes_pedido = QLabel(self.frame_12)
        self.label_ingredientes_pedido.setObjectName(u"label_ingredientes_pedido")
        self.label_ingredientes_pedido.setFont(font)

        self.verticalLayout_17.addWidget(self.label_ingredientes_pedido)
        ...
        self.label_observacoes_pedido = QLabel(self.frame_12)
        self.label_observacoes_pedido.setObjectName(u"label_observacoes_pedido")
        self.label_observacoes_pedido.setFont(font)

        self.verticalLayout_17.addWidget(self.label_observacoes_pedido)

        self.text_edit_observacao_item = QTextEdit(self.frame_12)
        ...
        self.verticalLayout_17.addWidget(self.text_edit_observacao_item)

        self.push_button_adicionar_item_pedido = QPushButton(self.frame_12)
        self.push_button_adicionar_item_pedido.setObjectName(u"push_button_adicionar_item_pedido")

        self.verticalLayout_17.addWidget(self.push_button_adicionar_item_pedido)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_telefone_pedido.setText(QCoreApplication.translate("MainWindow", u"Telefone", None))
        self.line_edit_telefone.setInputMask(QCoreApplication.translate("MainWindow", u"(00) 0000-0000", None))
        self.line_edit_telefone.setText(QCoreApplication.translate("MainWindow", u"(00) 0000-0000", None))
        self.line_edit_telefone.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Telefone (00) 0000-0000", None))
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"RJ", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"SP", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"SC", None))
