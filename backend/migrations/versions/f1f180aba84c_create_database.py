...
Revision ID: f1f180aba84c
Revises: 
Create Date: 2023-11-07 21:55:40.340070
...
def upgrade() -> None:
    ...
    sa.Column('status_uuid', sa.String(length=36), nullable=False),
    ...
    sa.Column('metodo_pagamento', sa.String(length=36), nullable=False),
    sa.Column('ativo', sa.Boolean(), server_default='true', nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('time_updated', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['metodo_pagamento'], ['metodos_pagamento.uuid'], ),
