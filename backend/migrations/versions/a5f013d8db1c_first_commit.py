...
Revision ID: a5f013d8db1c
Revises: 
Create Date: 2024-02-01 21:52:16.815778
...
def upgrade() -> None:
    ...
    sa.Column('produto_descricao', sa.Text(), nullable=True),
    ...
    sa.Column('produto_uuid', sa.String(length=36), nullable=False),
    sa.Column('valor', sa.Float(), nullable=True),
    sa.Column('dia_da_semana', sa.Enum('seg', 'ter', 'qua', 'qui', 'sex', 'sab', 'dom', name='dia_da_semana'), nullable=False),
    sa.Column('ativo', sa.Boolean(), server_default='true', nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('time_updated', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['produto_uuid'], ['produtos.uuid'], ),
    ...
    op.create_table('ingredientes_item_pedido',
    sa.Column('uuid', sa.String(length=36), nullable=False),
    sa.Column('nome', sa.Text(), nullable=False),
    sa.Column('item_uuid', sa.String(length=36), nullable=False),
    sa.Column('descricao', sa.Text(), nullable=True),
    sa.Column('incluso', sa.Boolean(), nullable=False),
    sa.Column('loja_uuid', sa.String(length=36), nullable=False),
    sa.Column('ativo', sa.Boolean(), server_default='true', nullable=False),
    sa.Column('time_created', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('time_updated', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['item_uuid'], ['itens_pedido.uuid'], ),
    sa.ForeignKeyConstraint(['loja_uuid'], ['lojas.uuid'], ),
    sa.PrimaryKeyConstraint('uuid'),
    sa.UniqueConstraint('uuid')
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('ingredientes_item_pedido')
